...
for (feature_index in 1:ncol(ZAS)) {
  ...
  if ((length(unique_val) == 2) &
    ...
    #Convert column from "character" to "numeric" object type.
    ZAS[,feature_name] = as.numeric(ZAS[,feature_name])
  }
}
```
